# vuelidate-error-extractor Contributing Guide
...
### Work Step Example
- Fork the repository from [dobromir-hristov/vuelidate-error-extractor](https://github.com/dobromir-hristov/vuelidate-error-extractor) !
- Create your topic branch from `development`: `git branch my-new-topic origin/development`
- Add codes and pass tests !
- Commit your changes: `git commit -am 'Add some topic'`
- Push to the branch: `git push origin my-new-topic`
- Submit a pull request to `development` branch of `dobromir-hristov/vuelidate-error-extractor` repository !
